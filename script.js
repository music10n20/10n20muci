const songs = [
    ...
    { title: "abhi abhi - new", src: "song35.mp3" },
    ...
    { title: "bheegi bheegi ratoon mein - new", src: "song40.mp3" },
    ...
    { title: "chalo tumko lekr chla - new ", src: "song52.mp3" },
    ...
    { title: "dilbara - new ", src: "song59.mp3" },
    ...
    { title: "hum ko maloom hai - new", src: "song65.mp3" },
    { title: "hum nahin - new", src: "song66.mp3" },
    { title: "te amo - new", src: "song67.mp3" },
    { title: "tera cherha - new", src: "song68.mp3" },
    { title: "tera bin - new ", src: "song69.mp3" },
    { title: "tu jo nahin - new", src: "song70.mp3" },
    { title: "ye dil diwana - new", src: "song71.mp3" },
    { title: "yeh raatein ye weather - new ", src: "song72.mp3" },
    { title: "pappu can't dance - new ", src: "song73.mp3" },
    { title: "meri mehbooba - new", src: "song74.mp3" },
    ...
    { title: "meri aawargi - new ", src: "song79.mp3" },
    { title: "Nagada Sang Dhol", src: "song80.mp3" },
    { title: "try me", src: "song81.mp3" },
    { title: "jadu hai nasha hai", src: "song82.mp3" },
    { title: "Meri Bheegi Bheegi Si ", src: "song83.mp3" },
    { title: "Jhoom Barabar Jhoom ", src: "song84.mp3" },
    { title: "jab koi baat bogad jaye - new", src: "song85.mp3" },
    { title: "i love you sayyoni  - new", src: "song86.mp3" },
    ...
    { title: "teri yadaan pav - new", src: "song94.mp3" }, 
    { title: "Dil Toh Bachcha ", src: "song95.mp3" }, 
    { title: "Isq Risk  ", src: "song96.mp3" }, 
    { title: "screen - kaka - new ", src: "song97.mp3" }, 
    { title: "Babam Bam - Kailash Kher", src: "song98.mp3" }, 
    { title: "libaas - kaka - new", src: "song99.mp3" }, 
    ...
    { title: "bewaffa pav- new", src: "song105.mp3" }, 
    { title: "dhoor pendi - new", src: "song106.mp3" }, 
    { title: "Sulthan - kgf", src: "song107.mp3" }, 
    { title: "ik kahani - new - kaka  ", src: "song108.mp3" }, 
    { title: "mera warga - new - kaka ", src: "song109.mp3" }, 
    { title: "mitti de tibba - new ", src: "song110.mp3" }, 
    { title: "Dil Ne Yeh Kaha ", src: "song111.mp3" }, 
    { title: "jaa bewafa ja ", src: "song112.mp3" }, 
    { title: "surama - kaka - new", src: "song113.mp3" }, 
    { title: "happy together ", src: "song114.mp3" }, 
    { title: "teejji seat ", src: "song115.mp3" }, 
    { title: "Aasman Ko Chukar Dekha  ", src: "song116.mp3" }, 
    { title: "Temporary Pyar", src: "song117.mp3" }, 
    ...
    { title: "sun flower", src: "song161.mp3" }, 
    { title: "sun flower", src: "song162.mp3" }, 
    { title: "sun flower", src: "song163.mp3" }, 
    { title: "sun flower", src: "song164.mp3" }, 
    { title: "sun flower", src: "song165.mp3" }, 
    { title: "sun flower", src: "song166.mp3" }, 
    { title: "sun flower", src: "song167.mp3" }, 
    { title: "sun flower", src: "song168.mp3" }, 
    { title: "sun flower", src: "song169.mp3" }, 
    { title: "sun flower", src: "song170.mp3" }, 
    { title: "sun flower", src: "song171.mp3" }, 
    { title: "sun flower", src: "song172.mp3" }, 
    { title: "sun flower", src: "song173.mp3" }, 
    { title: "sun flower", src: "song174.mp3" }, 
    { title: "sun flower", src: "song175.mp3" }, 
    { title: "sun flower", src: "song176.mp3" }, 
    { title: "sun flower", src: "song177.mp3" }, 
    { title: "sun flower", src: "song178.mp3" }, 
    { title: "sun flower", src: "song179.mp3" }, 
    { title: "sun flower", src: "song180.mp3" }, 
    { title: "sun flower", src: "song181.mp3" }, 
    { title: "sun flower", src: "song182.mp3" }, 
    { title: "sun flower", src: "song183.mp3" }, 
    { title: "sun flower", src: "song184.mp3" }, 
    { title: "sun flower", src: "song185.mp3" }, 
    { title: "sun flower", src: "song186.mp3" }, 
    { title: "sun flower", src: "song187.mp3" }, 
    { title: "sun flower", src: "song188.mp3" }, 
    { title: "sun flower", src: "song189.mp3" }, 
    { title: "sun flower", src: "song190.mp3" }, 
    { title: "sun flower", src: "song191.mp3" }, 
